...
*/
public class programmingAssignment4 extends Thread {
    public final int COUNT = 1000;
    private final Pair pair;
    // Ctor takes a pointer to the pair we use
    public programmingAssignment4(Pair pair) {
        this.pair = pair;
    }
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        programmingAssignment4 w1 = new programmingAssignment4(pair);
        programmingAssignment4 w2 = new programmingAssignment4(pair);
        programmingAssignment4 w3 = new programmingAssignment4(pair);
